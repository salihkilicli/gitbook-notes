...
**Root Mean Absolute Error:**  $$\text{RMAE} = \sqrt{\dfrac{1}{m} \sum\limits_{i=1}^{m} |y^{(i)} - \hat{y}^{(i)}| }= \sqrt{\dfrac{1}{m} ||y - \hat{y}||_{\ell^1}}$$****
...
![Bell-shaped curve: Normal distribution and Quartiles](../../../.gitbook/assets/normal\_dist.svg)
...
![](../../../.gitbook/assets/sampling\_comparison.png)
...
![An example of pairplot of housing data](../../../.gitbook/assets/pairplot\_example.png)
